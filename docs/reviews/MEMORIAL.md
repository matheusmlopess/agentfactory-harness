...
8. [Consolidated Implementation Review — `factory` (Waves 0–5)](#d8) — `2026-06-18` — When an assumption breaks, behavior ranges from graceful (PTY spawn failure → · [[REVIEW-CURRENT-STATE-2026-06-18]]
...
## 8 · 2026-06-18 · Consolidated Implementation Review — `factory` (Waves 0–5)
